...
class membro_plano_model extends CI_model{ 
    ...
    public function store(array $membroPlano){
      ...
      return $this->db->insert('associacao_membro_plano', $membroPlano);
    ...
    public function update($id, array $membroPlano){

      $what = $this->db->where('MembroID', $id);
     
      return $this->db->update('associacao_membro_plano', $membroPlano);
    }
