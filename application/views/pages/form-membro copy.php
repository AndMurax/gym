			...
			<?php endif ?>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<option value="<?= isset($planostreinos["NomePlano"]) ? $planostreinos["NomePlano"] : null ?>" selected> Selecione: </option>
							<?php foreach ($planostreinos as $planostreino) : ?>
								<option value="<?=$planostreino["PlanoID"]?>"><?= $planostreino["NomePlano"]?></option>
							<?php endforeach; ?>
